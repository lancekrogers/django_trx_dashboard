...
from wallets.models import User, Wallet, Chain
from transactions.models import Transaction, TransactionType, Asset
    ...
    def handle(self, *args, **options):
        ...
        for i in range(options['users']):
            ...
            for wallet in wallets:
                self._create_transactions(wallet, assets[wallet.chain], options['transactions'])
